...
//    //隐藏导航栏
    ...
    if (first ==  NO) {
        ...
        //不是第一次
        LaunchViewController *laungView = [[LaunchViewController alloc] initWithNibName:@"LaunchViewController" bundle:[NSBundle mainBundle]];
        
        [self.window setRootViewController:laungView];
    }
